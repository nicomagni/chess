...
@property (nonatomic, readonly, weak) NSRunLoop *runLoop;
...
- (void)scheduleInRunLoop:(NSRunLoop *)aRunLoop forMode:(NSString *)mode;
{
    ...
    NSArray* array = [NSArray arrayWithObjects:aRunLoop, mode, nil];
    [_scheduledRunloops addObject:array];
}
...
- (void)unscheduleFromRunLoop:(NSRunLoop *)aRunLoop forMode:(NSString *)mode;
{
    ...
    NSArray* array = [NSArray arrayWithObjects:aRunLoop, mode, nil];
    [_scheduledRunloops removeObject:array];
}
